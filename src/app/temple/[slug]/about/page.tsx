...
import AboutClient from '@/components/temple/about-client'

interface AboutPageProps {
  params: Promise<{ slug: string }>
}

export default async function PublicTempleAbout({ params }: AboutPageProps) {
  ...
  const serializableTemple = {
    name: temple.name,
    trustRegistrationNo: temple.trustRegistrationNo,
    slug: temple.slug,
  }
  ...
  return <AboutClient temple={serializableTemple} page={serializablePage} templateId={templateId} />
}
